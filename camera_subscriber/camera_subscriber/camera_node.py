...
class CameraNode(Node):
    ...
    def listener_callback(self, msg):
        ...
        try:
            ...
            # --- CORRECCIÓN PARA OPENCV 4.9+ ---
        # 1. Definimos parámetros de detección (necesarios para el constructor)
            aruco_params = cv2.aruco.DetectorParameters()

        # 2. Creamos el objeto Detector con el diccionario que ya tienes cargado
            detector = cv2.aruco.ArucoDetector(self.aruco_dict, aruco_params)

        # 3. Usamos el detector para encontrar los marcadores
